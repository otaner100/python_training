...
def executor_command(username, password, roteador, comandos):
    try:
        ...
        salvar_file = f"show_version_{roteador}" # cria a variavel salvar_file como o nome do file quando ser salvado
        ...
        print(sys.exc_info())
executor_command("admin", "admin", "192.168.56.120", cli_cisco)